...
11. Airport on sectional map: CT (control tower frequency); ATIS (weather frequency); elevation; L (longest runway in hundred ft); CTAF (with C in the end) or UNICOM (without letter in the end) frequency
